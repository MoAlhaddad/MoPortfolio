  ...
  return <Sheet>
    ...
    <SheetContent className="flex flex-col">
        ...
        <div className="mt-32 mb-40 text-center text-2xl ">
            <Link href="/" >
                <h1 className="text-4xl font-semibold">Mohamad<span className="text-accent">.</span></h1>
            </Link>
        </div>

        {/*nav */}
        <nav className="flex flex-col justify-center item-center gap-8">{links.map((link, index) => {
            return (
